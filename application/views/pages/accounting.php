            ...
            <nav class="menu">
                <ul>
                    ...
                    <li data-menu="Cash In Form" class="curson-pointer menuSelectionButton">
                        <div class="selected"></div>
                        <img src="<?php echo base_url('./public/images/icons/cashin.png'); ?>" alt="Cash In Icon">
                        <p>Cash-In Form</p>
                    </li>
                    ...
                    <li data-menu="Accounts" class="curson-pointer menuSelectionButton">
                        <div class="selected"></div>
                        <img src="<?php echo base_url('./public/images/icons/accounts.png'); ?>" alt="Accounts Icon">
                        <p>Accounts</p>
                    </li>
                    <li data-menu="Add Guest Account" class="curson-pointer menuSelectionButton">
                        <div class="selected"></div>
                        <img src="<?php echo base_url('./public/images/icons/group.png'); ?>" alt="Card Icon">
                    ...
                    <div id="My-Transactions-Footer-Query" class="panel-transactions-footer">
                        <div class="dropdown">
                            ...
                            <button class="dropdownButton dropdownbtn curson-pointer" data-layout="top">
                                ...
                                <img class="dropdown-arrow" src="<?php echo base_url('./public/images/icons/more.png.png'); ?>" alt="more">
                            </button>
                        </div>
                    </div>
                </div>
