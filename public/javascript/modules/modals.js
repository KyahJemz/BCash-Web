                ...
                <div class="Delete-Item">
                    <div class="form">
                        <div>
                            ...
                            <input id="DeleteItem-PINCode" minlength="6" maxlength="6" type="password">
                    ...
                    <fieldset class="pinCodeSettings">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input id="AccountSettings-NewPINCode1" minlength="6" maxlength="6"  type="password" name="NewPinCode" placeholder="******"></td>
                            </tr>
                            <tr>
                                <td><p>Re-type New PIN Code:</p></td>
                                <td><input id="AccountSettings-NewPINCode2" minlength="6" maxlength="6"  type="password" name="ConfirmNewPinCode" placeholder="******"></td>
                            </tr>
                        </table>
                    </fieldset>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input id="AccountSettings-OldPINCode" minlength="6" maxlength="6" type="password" name="OldPINCode" placeholder="">
                                </td>
                            </tr>
                        </table>
                    </fieldset>
