...
export function getTransactionHistory(transactionStartDate, transactionEndDate, transactionNumber, transactionName, transactionStatus, transactionsRecordPerPage){
...
export function displayToTable(table, data){
    let template = ``;
    let count = 0;
    console.log(data);
    if (data) {
